...
// 🔹 Fetch All Products
export const fetchProducts = (limit= 20, skip= 0, sortBy= "title", order= "asc") => async (dispatch: Dispatch) => {
  try {
...
export const fetchProductListByCategory = (categoryName: string, limit = 20, skip = 0, sortBy = "title", order = "asc") => async (dispatch: Dispatch) => {
  try {
...
export const fetchSearchedProductList = (searchTerm: string, limit = 20, skip = 0, sortBy = "title", order = "asc") => async (dispatch: Dispatch) => {
  try {
